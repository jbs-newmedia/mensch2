...
CREATE TABLE :table: (
	...
	license_version varchar(16) NOT NULL DEFAULT \'\',
	license_rank int(11) UNSIGNED NOT NULL DEFAULT 0,
	license_url varchar(64) NOT NULL DEFAULT \'\',
	license_file varchar(32) NOT NULL DEFAULT \'\',
	license_secure varchar(32) NOT NULL DEFAULT \'\',
	license_token varchar(32) NOT NULL DEFAULT \'\',
	license_status tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
	license_lastconnect int(11) UNSIGNED NOT NULL DEFAULT 0,
	...
	KEY license_rank (license_rank),
	KEY license_status (license_status),
	KEY license_lastconnect (license_lastconnect),
