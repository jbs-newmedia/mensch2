...
$Core->setTitle('Git reset | Clear');

require_once OSWMENSCH_CORE_ABSPATH.'php'.DIRECTORY_SEPARATOR.'header.inc.php';

$cmd='rm -R '.\osWMensch\Server\Configure::getValueAsString('git_path').'source';
...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">Git clear</h6>
	</div>
	<div class="card-body">
